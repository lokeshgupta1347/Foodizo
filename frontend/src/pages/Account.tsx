...
const Account = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="mx-auto max-w-md rounded-xl bg-white shadow-md">
        <div className="flex items-center gap-4 border-b p-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-500 text-2xl font-bold text-white">
            {firstLetter}
          </div>
          <div>
        ...
        <div className="divide-y">
            <div className="flex cursor-pointer items-center gap-4 p-5 hover:bg-gray-50" onClick={()=>navigate("/orders")}>
                ...
                <span  className="font-medium">Yours Orders</span>
